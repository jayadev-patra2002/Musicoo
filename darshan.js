const music=new Audio('darshan_songs/audio1.mp3')
// music.play()
...
const songs=[
    {
        ...
        poster:"darshan_images/img1.jpg"
    },
    {
        id:'2',
        songName:
        `Asal mein<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img2.jpg"
    },
    {
        id:'3',
        songName:
        `Mujhe Peene do<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img3.jpg"
    },
    {
        id:'4',
        songName:
        `Tera Zikr<br/>
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img4.jpg"
    },
    {
        id:'5',
        songName:
        `Baarish lete aana <br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img5.jpg"
    },
    {
        id:'6',
        songName:
        `Baarishon mein<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img6.jpg"
    },
    {
        id:'7',
        songName:
        `Bhula Diya<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img7.jpg"
    },
    {
        id:'8',
        songName:
        `Chogada<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img8.jpg"
    },
    {
        id:'9',
        songName:
        `Ek Tarfa<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img9.jpg"
    },
    {
        id:'10',
        songName:
        `Haaye Dard <br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img10.jpg"
    },
    {
        id:'11',
        songName:
        `Is Qadar<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img11.jpg"
    },
    {
        id:'12',
        songName:
        `Jannat Ve<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img12.jpg"
    },    {
        id:'13',
        songName:
        `Judaiyaan<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img13.jpg"
    },
    {
        id:'14',
        songName:
        `Kamariya<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img14.jpg"
    },
    {
        id:'15',
        songName:
        `Mahiye Jinna Sona<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img15.jpg"
    },
    {
        id:'16',
        songName:
        `Nayan ne bandh<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img16.jpg"
    },
    {
        id:'17',
        songName:
        `Rabba Mehar kari<br />
        <div class="subtitle">Darshan Raval</div>`,
        poster:"darshan_images/img17.jpg"
    },
    {
        id:'18',
        songName:
        `Shab Tum ho<br />
        <div class="subtitle">Darshan Ravall</div>`,
        poster:"darshan_images/img18.jpg"
    }
    // {
    //     id:'19',
    //     songName:
...
Array.from(document.getElementsByClassName('playListplay')).forEach((e)=>
{
   ...
   {
     index = el.target.id
     music.src=`darshan_songs/audio${index}.mp3`
     poster_master_play.src=`darshan_images/img${index}.jpg`
     music.play()
     wave.classList.add('active1')
     masterPlay.classList.remove('bi-play-fill')
     masterPlay.classList.add('bi-pause-fill')
